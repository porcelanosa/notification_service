...
## Функциональные требования (Бизнес-требования)⚙️
...
_Примечание: для внешних шлюзов используй классы-заглушки (моки), которые
имитируют работу реальных провайдеров._
